...
aps.dashboard_svg_icons = ( function( $, window, document, undefined ) {
	'use strict';
	...
	$(document).ready( function() {
		aps.dashboard_svg_icons.init();
	});

	return {
		init: function() {
			painter  = this;
			selector = $( '.aps-content-list .aps-cpt-icons, #dashboard_right_now .at-glance-cpt-icons' );
