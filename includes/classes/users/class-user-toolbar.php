...
class User_Toolbar {
	...
	public function register_menus() {
		...
		register_nav_menus(
			[
			'backend_toolbar_site'  => esc_html__( 'Admin Toolbar: Site Name', APS_CONFIG['domain'] ),
			'backend_toolbar_main'  => esc_html__( 'Admin Toolbar: Main', APS_CONFIG['domain'] ),
			'backend_toolbar_user'  => esc_html__( 'Admin Toolbar: User', APS_CONFIG['domain'] ),
			'frontend_toolbar_site' => esc_html__( 'Frontend Toolbar: Site Name', APS_CONFIG['domain'] ),
			'frontend_toolbar_main' => esc_html__( 'Frontend Toolbar: Main', APS_CONFIG['domain'] ),
			'frontend_toolbar_user' => esc_html__( 'Frontend Toolbar: User', APS_CONFIG['domain'] )
			]
		);
	}
