...
class Register_ACF_Family_Options extends Add_ACF_Suboptions {
	 ...
	 */
	protected $parent_slug = 'edit.php?post_type=family';
	 ...
	 *                menu is selected.
	 */
	protected $page_title = 'Family Settings';
	 ...
	 */
	protected $menu_title = 'Family Settings';
	 ...
	 */
	protected $menu_slug = 'family-options';
	...
	public function field_groups() {
		include_once APS_PATH . '/includes/fields/acf-family-settings.php';
	}
}
