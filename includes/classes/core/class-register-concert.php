...
class Register_Concert extends Register_Type {
	 ...
	 * @since  1.0.0
	 * @access protected
	 * @var    string The dashicon class.
	 */
	protected $menu_icon = 'dashicons-format-audio';
