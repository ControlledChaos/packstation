...
class Content_Settings extends Add_Settings_Page {
	...
	public function tabs() {
		...
		$this->add_content_tab( [
			...
			'tab'        => __( 'Intro', APS_CONFIG['domain'] ),
			'heading'    => __( 'Introduction', APS_CONFIG['domain'] ),
			'content'    => __( 'In development', APS_CONFIG['domain'] ),
			'callback'   => ''
		] );
	}
	...
	protected function heading() {
		return __( 'Content Settings', APS_CONFIG['domain'] );
	}
}
