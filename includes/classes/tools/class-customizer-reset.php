...
namespace PackStation\Classes\Tools;
...
final class Customizer_Reset {
	...
	public function scripts() {
		...
		wp_enqueue_script( 'aps-customizer-reset', APS_URL . 'assets/js/customizer-reset' . $suffix . '.js', [ 'jquery' ], '20150120' );

		// Localize the above script.
		wp_localize_script( 'aps-customizer-reset', 'APS_CustomizerReset', [
			'reset'   => __( 'Reset', APS_CONFIG['domain'] ),
			'confirm' => __( 'Warning! This will remove all changes made to this theme via the Customizer. This action is irreversible.', APS_CONFIG['domain'] ),
			'nonce'   => [
