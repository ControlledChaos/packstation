...
class Add_Page extends Classes\Base {
	...
	protected function page_title() {
		return __( $this->page_title, APS_CONFIG['domain'] );
	}
	...
	protected function menu_title() {
		return ucwords( __( $this->menu_title, APS_CONFIG['domain'] ) );
	}
	 ...
	 * Hooking into `aps_submanu_page_content` adds
	...
	public function help() {
		...
		$screen->add_help_tab( [
			'id'       => 'more_info',
			'title'    => __( 'More Information', APS_CONFIG['domain'] ),
			'content'  => null,
	...
	public function more_info() {
		include_once APS_PATH . 'views/backend/help/sample-more-info.php';
	}
	...
	protected function sidebar() {
		...
		include_once APS_PATH . 'views/backend/help/sample-sidebar.php';
	...
	public function admin_parent_enqueue_scripts() {
		...
		wp_enqueue_script( APS_CONFIG['admin_slug'] . '-tabs', APS_URL . 'assets/js/admin-tabs' . $suffix . '.js', [ 'jquery' ], '', true );
	}
	...
	public function admin_parent_print_styles() {
		...
		$style  = '<style>';
		$style .= file_get_contents( APS_PATH . 'assets/css/admin-tabs.min.css' );
		$style .= '</style>';
		echo $style;
	}
}
