...
class Sample_Subpage extends Add_Subpage {
	 ...
	 */
	protected $menu_slug = APS_BASENAME . '-sample-subpage';
	...
	protected function heading() {
		return __( 'Sample Submenu Page', APS_CONFIG['domain'] );
	}
	...
	public function tabs() {
		...
		$this->add_content_tab( [
			'id'         => 'sample-one',
			'tab'        => __( 'One', APS_CONFIG['domain'] ),
			'heading'    => __( 'Settings One', APS_CONFIG['domain'] ),
			'content'    => '',
		...
		$this->add_content_tab( [
			'id'         => 'sample-two',
			'tab'        => __( 'Two', APS_CONFIG['domain'] ),
			'heading'    => __( 'Settings Two', APS_CONFIG['domain'] ),
			'content'    => '',
			'callback'   => [ $this, 'sample_tab' ]
		] );
	}
	...
	public function sample_tab() {
		include APS_PATH . 'views/backend/pages/sample-page-content.php';
	}
}
